...
export const CATEGORIES = {
  ...
  fungicide: {
    ...
    aiPhotoPrompt: 'Act as an expert plant pathologist with open-domain vision capability. Analyze this fungicide trial photo to dynamically identify ANY fungal, bacterial, viral, or physiological disease symptom visible. Do not use hardcoded or fixed disease lists — identify whatever pathogen is visually present on leaves, stems, or fruits. Provide the exact "Common Name (Scientific Name)" for each detected target. Estimate disease severity percentage (0-100%) and disease incidence based strictly on real visual evidence.',
  ...
  pesticide: {
    ...
    aiPhotoPrompt: 'Act as an expert agricultural entomologist with open-domain vision capability. Analyze this pesticide trial photo to dynamically identify ANY crop pest insect, mite, larva, or arthropod species present, as well as feeding damage. Do not use hardcoded or fixed pest lists — identify whatever insect or damage is visually present. Provide the exact "Common Name (Scientific Name)" for each detected pest. Estimate pest count, live vs dead count, feeding damage percentage (0-100%), and crop damage rating (0-9) based strictly on real visual evidence.',
