...
export async function generateProjectDocx(reportData, options = {}) {
  ...
  // ─── Section 1: Trial Design & Methodology ──────────────────────────────────
  ...
  const section1Elements = [
    heading('1. Trial Design & Methodology', HeadingLevel.HEADING_2),
    spacer(),
    bodyPara(
  ...
  const section2Elements = [
    heading('2. Treatment List', HeadingLevel.HEADING_2),
    spacer(),
    makeTable(
  ...
  let section3Elements = [
    heading('3. Raw Observation Data', HeadingLevel.HEADING_2),
    spacer(),
    bodyPara(
  ...
  const section4Elements = [
    heading('4. Treatment Means & Statistics', HeadingLevel.HEADING_2),
    spacer(),
  ];
  ...
  if (daas.length >= 2) {
    ...
    section5Elements.push(
      heading('5. Time-Series Means', HeadingLevel.HEADING_2),
      spacer(),
