...
export default function ReportConfigPanel({ project, subTrials = [], activeCategory, onGenerate, canDownload }) {
  ...
  const formatLabel = { pdf: 'PDF', excel: 'Excel', docx: 'DOCX' }[format] || format.toUpperCase();
  ...
  function handleGenerate() {
    ...
    onGenerate?.({ format, postHoc, alpha, daa, transformation, includePhotos, includeWeather });
  }
